...
DFTI_NEGATIVE               = _ctypes.c_int(37) # -distance, for setting definition of transform
DFTI_POSITIVE               = _ctypes.c_int(38) # +distance, for setting definition of transform
